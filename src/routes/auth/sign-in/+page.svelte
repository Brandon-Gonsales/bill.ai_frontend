			...
			<div class="space-y-4">
				...
				<div class="flex items-start">
					...
					<div>
						...
						<p class="text-sm text-red-100">PDF y imágenes</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="flex flex-1 items-center justify-center p-8">
		<div class="w-full max-w-md">
			...
			<div class="mb-8 flex items-center justify-center lg:hidden">
				<svg viewBox="0 0 24 24" fill="none" class="mr-3 h-10 w-10 text-light-tertiary">
					<path
						d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"
						stroke="currentColor"
						stroke-width="2"
				...
				<span class="text-2xl font-bold text-light-secondary">Bill AI</span>
			</div>

			<div class="mb-8">
				<h2 class="mb-2 text-3xl font-bold text-light-black">Iniciar Sesión</h2>
				<p class="text-light-black">Ingresa tus credenciales para continuar</p>
			</div>
